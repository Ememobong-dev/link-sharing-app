            ...
            <Col xs={24} lg={12}>
              <div className="bg-white rounded-lg h-full flex flex-col">
                ...
                <div className="flex justify-end mt-5 px-14">
                  <button className="bg-indigo-700 py-2 px-5 rounded-lg text-white hover:bg-transparent hover:text-black cursor-pointer border border-indigo-700">Save</button>
                </div>
              </div>
            </Col>
          </Row>
